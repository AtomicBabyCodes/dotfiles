...
globalkeys = gears.table.join(
    ...
    --Calibre 
    awful.key({ modkey, "Shift" },            "c",     function () awful.util.spawn("calibre") end,
              {description = "run calibre", group = "launcher"}),
          
    --qbittorrent 
    awful.key({ modkey },            "q",     function () awful.util.spawn("qbittorrent") end,
              {description = "run qbittorrent", group = "launcher"}),
...
awful.spawn.with_shell("numlockxon")
...
awful.spawn.with_shell("picom -b --config ~/.config/picom.conf")
awful.spawn.with_shell("kmix")
awful.spawn.with_shell("/home/kishlaya/.config/polybar/launch.sh")
